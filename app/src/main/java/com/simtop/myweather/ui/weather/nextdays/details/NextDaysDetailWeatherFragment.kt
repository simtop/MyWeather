...
class NextDaysDetailWeatherFragment : ScopedFragment(), KodeinAware {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val safeArgs = arguments?.let { NextDaysDetailWeatherFragmentArgs.fromBundle(it) }
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactoryInstanceFactory(date))
            .get(NextDaysDetailWeatherViewModel::class.java)
    ...
    private fun bindUI() = launch(Dispatchers.Main) {
        ...
        weatherLocation.observe(this@NextDaysDetailWeatherFragment, Observer { location ->
            if (location == null) return@Observer
            updateLocation(location.name)
        })

        futureWeather.observe(this@NextDaysDetailWeatherFragment, Observer { weatherEntry ->
